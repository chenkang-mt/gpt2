...
if __name__ == '__main__':
    ...
    train_loader = DataLoader(data, batch_size=args.train_batch_size, shuffle=True, pin_memory=False)
    ...
    while STEPS < args.num_train_steps:
        ...
        for features in train_loader:
            ...
            # all_eval_time = time.time() - start_eval_time
            ...
            if STEPS % args.log_steps == 0:
                ...
                logger.info(f'eval_time is {(all_eval_time / args.log_steps) :.3f}')
                avg_step_time = all_time / args.log_steps
                logger.info(f'all_time is {avg_step_time :.3f}')
                logger.info(f'avg fps is {args.train_batch_size/avg_step_time :.3f}')
